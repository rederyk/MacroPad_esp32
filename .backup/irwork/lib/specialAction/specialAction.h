...
public:
    ...
    /// IR remote control management (gesture-like pattern)
    void scanIR(bool pressed, int deviceId);     // Scan IR signal and save with keypad selection
    void sendIR(bool pressed, int deviceId);     // Send IR signal with keypad selection
